 ...
 * @author Erick Leija
 */
@Component("treeViewFunctionalClassifier")
public class TreeviewFunctionalClassifierUIHelper
{
    ...
    private void createTreeview(Long aDependenceId) 
    {
        ...
        String myRootName = "CLASIFICACION FUNCIONAL";
        ...
        List<FunctionalClassifierEntity> myObjectivesToCast = (List<FunctionalClassifierEntity>)theirFunctionalClassifierManagement.getMyFunctionalClassifierAncestry(aDependenceId);
        ...
        for(Object myObjectiveCast: myObjectivesToCast)
        {
            ...
            myWorkingDto= new ObjectiveJoinLevelTreeviewDto
                    (((String)myObjectFields[3]), ((String)myObjectFields[2]), ((Long)myObjectFields[0]),
                    ((Long)myObjectFields[1]), ((String)myObjectFields[3]), ((String)myObjectFields[4]),
