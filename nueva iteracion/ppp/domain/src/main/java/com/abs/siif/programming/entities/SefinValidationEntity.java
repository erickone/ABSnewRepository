 ...
 */
@Entity
@Table(name = "siifpppvalsefin")
public class SefinValidationEntity   
              implements Comparable<SefinValidationEntity>, Serializable
{
  @Id
  @GenericGenerator(name = "generator", strategy = "native")
  @GeneratedValue(generator = "generator")
  @Column(name = "IdValSefin", nullable = false)
  ...
  @Override
  public int compareTo(SefinValidationEntity o)
  {
