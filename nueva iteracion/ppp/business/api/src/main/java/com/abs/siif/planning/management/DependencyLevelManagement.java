 ...
 *  All rights reserved 
 *  Filename:  DependencyLevelManagement
 ...
 */
public interface DependencyLevelManagement {
      /*
     * Retorna un nivel de dependencia de acuerdo a un nivel en especifico
     */
    DependenceLevelEntity getDependencyLevelByLevel(DependenceLevelEntity 
    ...
    DependenceLevelEntity getDependenceLevelWithColective(DependenceLevelEntity 
        ...
        DependenceLevelEntity getDependenceLevelByLevelByAnnio(short aLevel);
}
